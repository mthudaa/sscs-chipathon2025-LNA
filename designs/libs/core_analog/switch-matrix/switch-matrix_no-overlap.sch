...
C {lab_wire.sym} 1050 -200 0 1 {name=p26 lab=CLKA}
...
C {/foss/designs/sscs-chipathon2025-LNA/designs/libs/core_analog/digital/digital_inv_1.sym} 1010 -200 0 0 {name=x10 VSS=VSS VDD=VDD}
