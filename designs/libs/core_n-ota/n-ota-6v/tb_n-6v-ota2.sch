...
C {vsource.sym} 160 -370 0 0 {name=V2 value="SINE(0 -3 10k) dc 3" savecurrent=false}
C {vsource.sym} 160 -280 0 0 {name=V3 value="SINE(0 3 10k) dc 3" savecurrent=false}
...
.endc
"}
C {devices/code_shown.sym} 860 -250 0 0 {name=MODELS2 only_toplevel=true
