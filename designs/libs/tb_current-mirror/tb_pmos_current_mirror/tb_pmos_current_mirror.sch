...
"}
C {core_current-mirror/pmos_current_mirror/pmos_current_mirror.sym} 120 -110 0 0 {name=x1}
C {lab_pin.sym} -140 0 0 1 {name=p9 lab=VDD}
C {vsource.sym} -140 50 0 0 {name=Vd value=5 savecurrent=false}
...
C {lab_pin.sym} -20 90 3 0 {name=p8 lab=IBIAS}
C {lab_pin.sym} -20 30 3 1 {name=p20 lab=VSS}
C {isource.sym} -20 60 2 0 {name=I0 value=10u}
C {lab_wire.sym} 270 -160 0 1 {name=p1 lab=IBIAS}
C {lab_wire.sym} 270 -140 0 1 {name=p2 lab=I1}
C {lab_wire.sym} 270 -120 0 1 {name=p3 lab=I2}
C {lab_wire.sym} 270 -100 0 1 {name=p4 lab=VDD}
C {lab_wire.sym} 270 -80 0 1 {name=p5 lab=I4}
C {lab_wire.sym} 270 -60 0 1 {name=p6 lab=I3}
