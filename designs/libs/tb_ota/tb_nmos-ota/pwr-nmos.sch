...
C {lab_pin.sym} 510 -620 0 1 {name=p4 sig_type=std_logic lab=OUT}
...
C {/foss/designs/sscs-chipathon2025-LNA/designs/libs/core_n-ota/nmos-ota/nmos-ota.sym} 360 -600 0 0 {name=x3}
