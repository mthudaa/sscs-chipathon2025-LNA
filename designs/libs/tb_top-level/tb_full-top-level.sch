...
C {lab_wire.sym} 690 -1130 0 0 {name=p1 lab=DATA_PX}
C {lab_wire.sym} 690 -1170 0 0 {name=p4 lab=RSTN_PX}
C {lab_wire.sym} 690 -1150 0 0 {name=p11 lab=CLK_PX}
...
C {sscs-chipathon2025-LNA/designs/libs/core_top-level/top-level/top-level-pad.sym} 840 -1170 0 0 {name=x1}
C {lab_wire.sym} 690 -1210 0 0 {name=p2 lab=VDD}
C {lab_wire.sym} 690 -1190 0 0 {name=p3 lab=VSS}
C {lab_wire.sym} 990 -1210 0 1 {name=p34 lab=PAD_IO[15:0]}
