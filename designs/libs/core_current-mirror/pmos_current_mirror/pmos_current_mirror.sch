...
N 850 200 850 250 {lab=VDD}
N 850 280 940 280 {lab=VDD}
N 850 310 850 350 {lab=I5}
...
C {symbols/pfet_03v3.sym} 830 280 0 0 {name=M5
L=5u
W=15.5u
nf=1
m=5
...
C {lab_pin.sym} 810 280 0 0 {name=p23 lab=VBIAS}
C {lab_pin.sym} 850 200 0 1 {name=p24 lab=VDD}
C {iopin.sym} 850 350 2 1 {name=p25 lab=I5}
C {lab_pin.sym} 940 280 0 1 {name=p26 lab=VDD}
