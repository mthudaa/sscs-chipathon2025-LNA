# Tcl script to run LVS on switch-matrix-16x1
...
set circuit1 [readnet spice switch-matrix-16x1_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice switch-matrix-16x1.spice $circuit2

lvs "$circuit1 switch-matrix-16x1" "$circuit2 switch-matrix-16x1" \
        $setupfile switch-matrix-16x1_comp.out
