...
N 40 0 60 0 {lab=Iref}
N 140 -90 140 -70 {lab=vdd}
N -220 60 -220 70 {lab=GND}
N -220 -120 -220 -90 {lab=vss}
N -220 -90 -220 -60 {lab=vss}
N 220 0 250 0 {lab=vss}
N -220 70 -220 80 {lab=GND}
C {lab_wire.sym} 140 -70 3 1 {name=p3 sig_type=std_logic lab=vdd}
C {isource.sym} -60 30 0 1 {name=Iref value=5u}
C {gnd.sym} -60 80 0 0 {name=l1 lab=GND}
C {lab_wire.sym} 60 0 0 0 {name=p1 sig_type=std_logic lab=Iref}
...
dc Iref 0 5u 0.01u
write tb_pmos_current_mirror.raw
plot i(Vmeas) i(Vref)
.endc
.end
"}
...
C {lab_wire.sym} -220 -90 0 1 {name=p6 sig_type=std_logic lab=vss
}
C {lab_wire.sym} 220 0 1 1 {name=p7 sig_type=std_logic lab=vss
}
...
C {libs/core_analog/current-mirror/pmos_current_mirror.sym} 140 0 0 0 {name=x1}
