# Tcl script to run LVS on nbias-gen
...
set circuit1 [readnet spice nbias-gen_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice ../../../simulations/nbias-gen.spice $circuit2

lvs "$circuit1 nbias-gen" "$circuit2 nbias-gen" \
        $setupfile nbias-gen_comp.out
