...
C {ammeter.sym} 620 -350 0 0 {name=Vmeas savecurrent=true spice_ignore=0}
C {lab_wire.sym} 620 -380 0 1 {name=p10 lab=OUT}
...
C {libs/switch-matrix/trans-gate/trans-gate.sym} 470 -440 0 0 {name=x1}
