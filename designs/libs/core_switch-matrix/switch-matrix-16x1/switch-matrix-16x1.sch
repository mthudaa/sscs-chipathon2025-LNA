...
C {core_switch-matrix/switch-cell/switch-cell.sym} 450 -630 0 0 {name=x1}
C {core_switch-matrix/switch-cell/switch-cell.sym} 890 -630 0 0 {name=x2}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1330 -630 0 0 {name=x3}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1770 -630 0 0 {name=x4}
C {core_switch-matrix/switch-cell/switch-cell.sym} 450 -490 0 0 {name=x5}
C {core_switch-matrix/switch-cell/switch-cell.sym} 890 -490 0 0 {name=x6}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1330 -490 0 0 {name=x7}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1770 -490 0 0 {name=x8}
C {core_switch-matrix/switch-cell/switch-cell.sym} 450 -350 0 0 {name=x9}
C {core_switch-matrix/switch-cell/switch-cell.sym} 890 -350 0 0 {name=x10}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1330 -350 0 0 {name=x11}
C {core_switch-matrix/switch-cell/switch-cell.sym} 1770 -350 0 0 {name=x12}
C {core_switch-matrix/switch-cell/switch-cell.sym} 450 -210 0 0 {name=x13}
