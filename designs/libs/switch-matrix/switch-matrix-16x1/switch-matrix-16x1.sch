...
C {lab_wire.sym} 600 -190 0 1 {name=p5 lab=IN}
...
C {iopin.sym} 100 -180 0 0 {name=p8 lab=IN}
...
C {lab_wire.sym} 1040 -190 0 1 {name=p18 lab=IN}
...
C {lab_wire.sym} 1480 -190 0 1 {name=p25 lab=IN}
...
C {lab_wire.sym} 1920 -190 0 1 {name=p32 lab=IN}
...
C {lab_wire.sym} 600 -330 0 1 {name=p47 lab=IN}
...
C {lab_wire.sym} 1040 -330 0 1 {name=p52 lab=IN}
...
C {lab_wire.sym} 1480 -330 0 1 {name=p56 lab=IN}
...
C {lab_wire.sym} 1920 -330 0 1 {name=p60 lab=IN}
...
C {lab_wire.sym} 600 -470 0 1 {name=p80 lab=IN}
...
C {lab_wire.sym} 1040 -470 0 1 {name=p85 lab=IN}
...
C {lab_wire.sym} 600 -610 0 1 {name=p113 lab=IN}
...
C {lab_wire.sym} 1040 -610 0 1 {name=p118 lab=IN}
...
C {lab_wire.sym} 1480 -610 0 1 {name=p122 lab=IN}
...
C {lab_wire.sym} 1920 -610 0 1 {name=p126 lab=IN}
...
C {libs/switch-matrix/switch-cell/switch-cell.sym} 450 -630 0 0 {name=x1}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 890 -630 0 0 {name=x2}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1330 -630 0 0 {name=x3}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1770 -630 0 0 {name=x4}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 450 -490 0 0 {name=x5}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 890 -490 0 0 {name=x6}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1330 -490 0 0 {name=x7}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1770 -490 0 0 {name=x8}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 450 -350 0 0 {name=x9}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 890 -350 0 0 {name=x10}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1330 -350 0 0 {name=x11}
C {libs/switch-matrix/switch-cell/switch-cell.sym} 1770 -350 0 0 {name=x12}
...
C {libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 360 -100 0 0 {name=x17 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 440 -100 0 0 {name=x18 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 360 -30 0 0 {name=x19 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {libs/gf180mcu_fd_sc_mcu9t5v0_symbols/inv_1.sym} 440 -30 0 0 {name=x20 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
