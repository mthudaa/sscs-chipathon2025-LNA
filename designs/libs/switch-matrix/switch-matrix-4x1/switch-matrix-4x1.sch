...
C {iopin.sym} 100 -160 0 0 {name=p9 lab=OUT[3:0]}
C {lab_wire.sym} 300 -250 0 0 {name=p12 lab=D}
...
C {ipin.sym} 100 -80 0 0 {name=p13 lab=RSTN}
C {ipin.sym} 100 -120 0 0 {name=p14 lab=CLK_PH1}
C {ipin.sym} 100 -100 0 0 {name=p49 lab=CLK_PH2}
C {lab_wire.sym} 300 -110 0 0 {name=p38 lab=CLK_PH1}
