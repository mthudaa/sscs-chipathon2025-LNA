# Tcl script to run LVS on nfet-vss
...
set circuit1 [readnet spice nfet-vss_layout.spice]
set circuit2 [readnet spice $sclib]

readnet spice nfet-vss.spice $circuit2

lvs "$circuit1 nfet-vss" "$circuit2 nfet-vss" \
        $setupfile nfet-vss_comp.out
