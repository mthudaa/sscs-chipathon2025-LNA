...
N 360 -120 390 -120 {lab=#net2}
N 360 -60 390 -60 {lab=#net3}
...
C {inv_1.sym} 430 -120 0 0 {name=x6 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {inv_1.sym} 320 -60 0 0 {name=x7 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {inv_1.sym} 430 -60 0 0 {name=x8 VGND=VSSd VNB=VDDd VPB=VSSd VPWR=VDDd prefix=gf180mcu_fd_sc_mcu9t5v0__ }
C {lab_wire.sym} 280 -120 0 0 {name=p27 lab=CLK1}
C {lab_wire.sym} 280 -60 0 0 {name=p28 lab=CLK2}
C {lab_wire.sym} 470 -120 0 1 {name=p29 lab=CLK1_BUFF}
C {lab_wire.sym} 470 -60 0 1 {name=p30 lab=CLK2_BUFF}
