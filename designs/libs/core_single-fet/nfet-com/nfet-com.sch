...
C {iopin.sym} 120 -220 0 1 {name=p1 lab=D1}
C {iopin.sym} 120 -200 0 1 {name=p2 lab=G1}
C {iopin.sym} 120 -180 0 1 {name=p3 lab=D2}
C {iopin.sym} 120 -160 0 1 {name=p4 lab=G2}
C {iopin.sym} 120 -140 0 1 {name=p5 lab=D3}
C {iopin.sym} 120 -120 0 1 {name=p6 lab=G3}
C {iopin.sym} 120 -100 0 1 {name=p7 lab=D4}
C {iopin.sym} 120 -80 0 1 {name=p8 lab=G4}
